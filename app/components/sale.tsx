...
import { cleanLogs, getConfigs, getLogs, getMsgModel, getMsgVariables, getSessions, handleSaveConfig, handleSaveMsgModel } from "@/service/saleService"
import { CircleQuestionMark, MessageSquareText, Settings2, Tags } from "lucide-react"
            ...
            <div className="p-6">
                <div className="text-black max-w-[1366px] m-auto">
                    <PageTitle
                        Icon={Tags}
                        title={"Vendas"}
                        subtitle={"Personalize a mensagem automática e gerencie os envios de vendas"}
                    />
                    <Container>
                        <PageSubTitle
                            ...
                            <div className="flex justify-between">
                                <div>
                                    ...
                                    <p className="text-gray-600 text-sm">
                                        Personalize a mensagem que será enviada automaticamente com as vendas.
                                    </p>
                                </div>
                                <CircleQuestionMark
