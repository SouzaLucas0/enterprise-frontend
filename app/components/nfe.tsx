import { cleanLogs, getConfigs, getLogs, getMsgModel, getMsgVariables, getSessions, handleSaveConfig, handleSaveMsgModel } from "@/service/nfeService"
import { CircleQuestionMark, Clock, MessageSquareText, PhoneForwarded, Power, Settings2, StickyNote, Zap } from "lucide-react"
            ...
            <div className="p-6">
                <div className="text-black max-w-[1366px] m-auto">
                    <PageTitle
                        Icon={StickyNote}
                        title={"Nota Fiscal"}
                        subtitle={"Personalize a mensagem automática e gerencie os envios de notas fiscais"}
                    />
                    <Container>
                        <PageSubTitle
                            ...
                            <div className="flex justify-between">
                                <div>
                                    ...
                                    <p className="text-gray-600 text-sm">
                                        Personalize a mensagem que será enviada automaticamente com a nota fiscal.
                                    </p>
                                </div>
                                <CircleQuestionMark
